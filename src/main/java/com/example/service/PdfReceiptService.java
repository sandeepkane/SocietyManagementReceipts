...
public class PdfReceiptService {
    ...
    public static final String DEST = "src/main/resources/static/receipt";
    public static final String EXTENSION = ".pdf";


    public void generateReceipt(Receipt receipt) throws Exception {
        int random = new Random().nextInt();
        String fileName = DEST + random + EXTENSION;
//        File file = new File(fileName);
//        file.getParentFile().mkdirs();

        manipulatePdf(receipt, fileName);
    }

    protected void manipulatePdf(Receipt receipt, String fileName) throws Exception {
